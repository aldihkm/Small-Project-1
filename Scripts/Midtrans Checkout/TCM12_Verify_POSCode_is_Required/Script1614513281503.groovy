...
WebUI.click(findTestObject('Object Repository/Midtrans_Shopping_Cart/txt_postal_code'))

WebUI.clearText(findTestObject('Object Repository/Midtrans_Shopping_Cart/txt_postal_code'))

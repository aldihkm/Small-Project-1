...
WebUI.click(findTestObject('Object Repository/Midtrans_Shopping_Cart/txt_address'))

WebUI.clearText(findTestObject('Object Repository/Midtrans_Shopping_Cart/txt_address'))

...
WebUI.click(findTestObject('Object Repository/Midtrans_Shopping_Cart/txt_phone_number'))

WebUI.clearText(findTestObject('Object Repository/Midtrans_Shopping_Cart/txt_phone_number'))

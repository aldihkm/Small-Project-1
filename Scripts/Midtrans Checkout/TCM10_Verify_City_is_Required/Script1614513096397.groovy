...
WebUI.click(findTestObject('Object Repository/Midtrans_Shopping_Cart/txt_city'))

WebUI.clearText(findTestObject('Object Repository/Midtrans_Shopping_Cart/txt_city'))
